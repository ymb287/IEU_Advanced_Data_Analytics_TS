...
For Italy's GDP and CPI, we decided to use the Holt-Winters forecasting method as we saw that seasonality was heavily present. The results can be seen visually in the following graphs. 
