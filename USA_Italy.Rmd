...
After using the recommended number of differences (1) on Italy's GDP the Augmented Dickey-Fuller (ADF) test suggested marginal evidence against stationarity (p = 0.0675), as well as no further differencing. Since this is not completely stationary using the knowledge from the plotted data the seasonal component was added. In the seasonal scenario (season = 4), the ADF test provided strong evidence for stationarity (p = 0.01). This suggests using one difference in the modeling part, as well as including a seasonal component with a lag of 4.
#model description
...
For Italy's CPI the Augmented Dickey-Fuller (ADF) test suggested the need for (1) difference of the data, as it has a p value of 0.9505348 suggesting evidence against stationarity.
...
After using the recommended number of differences (1) on Italy's CPI the Augmented Dickey-Fuller (ADF) test suggested marginal evidence against stationarity (p = 0.01 ), as well as no further differencing. Since this is  completely stationary using the knowledge from the plotted data no seasonal component was added. 
...
For Italy's stock data the Augmented Dickey-Fuller (ADF) test suggested the need for (1) difference of the data, as it has a p value of 0.4086553 suggesting evidence against stationarity.
...
After using the recommended number of differences (1) on Italy's stock data the Augmented Dickey-Fuller (ADF) test suggested marginal evidence against stationarity (p = 0.01 ), as well as no further differencing. Since this is  completely stationary using the knowledge from the plotted data no seasonal component was added
...
For USA GDP data the Augmented Dickey-Fuller (ADF) test suggested the need for (1) difference of the data, as it has a p value of 0.8173736 suggesting evidence against stationarity.
...
After using the recommended number of differences (1) on USA GDP the Augmented Dickey-Fuller (ADF) test suggested evidence against stationarity (p = 0.1222529 ), as well as no further differencing. Since this is not completely stationary using the knowledge from the plotted data the seasonal component was added. In the seasonal scenario (season = 4), the ADF test provided strong evidence for stationarity (p = 0.01). This suggests using one difference in the modeling part, as well as including a seasonal component with a lag of 4.
...
For USA cpi data the Augmented Dickey-Fuller (ADF) test suggested the need for (1) difference of the data, as it has a p value of 0. 0.6018541 suggesting evidence against stationarity.
...
After using the recommended number of differences (1) on USA cpi the Augmented Dickey-Fuller (ADF) test suggested marginal evidence against stationarity (p = 0.01 ), as well as no further differencing. Since this is  completely stationary using the knowledge from the plotted data no seasonal component was added
...
For USA stock data the Augmented Dickey-Fuller (ADF) test suggested the need for (1) difference of the data, as it has a p value of 0.  0.4115169 suggesting evidence against stationarity.
...
After using the recommended number of differences (1) on USA stock the Augmented Dickey-Fuller (ADF) test suggested marginal evidence against stationarity (p = 0.01 ), as well as no further differencing. Since this is  completely stationary using the knowledge from the plotted data no seasonal component was added
