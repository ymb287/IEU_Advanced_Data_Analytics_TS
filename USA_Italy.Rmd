...
```{r modelling italy cpi2, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}

# Plot the forecast
plot_forecast_arima(cpi_italy_train, cpi_italy_test, transformed_italy$cpi, "Italy", "CPI", model_bic)
