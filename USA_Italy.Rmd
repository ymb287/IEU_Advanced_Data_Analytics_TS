...
evaluate_arima_models <- function(models, test_data) {
  ...
  results <- data.frame(Model = character(), AIC = numeric(), SIC = numeric(), BIC = numeric(), Residuals = character(), MPSE = numeric())
  ...
  for (model in models) {
    ...
    result_row <- data.frame(Model = name, AIC = aic, SIC = sic, BIC = bic, Residuals = residuals_check, MPSE = mpse)
