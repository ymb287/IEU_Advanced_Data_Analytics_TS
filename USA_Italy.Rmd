...
Indication of a drift or linear trend that is not diffenced (no clue why)
...
```
TODO Heteroskedasticity so should we use GARCH or use log or maybe box cox?
TODO Descripiton
